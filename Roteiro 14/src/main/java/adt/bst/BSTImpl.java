...
public class BSTImpl<T extends Comparable<T>> implements BST<T> {
   ...
   protected int preOrder(BSTNode<T> node, T[] arraySaida, int index) {
      if (!node.isEmpty()) {
   ...
   protected int order(BSTNode<T> node, T[] arraySaida, int index) {
      if (!node.isEmpty()) {
   ...
   protected int postOrder(BSTNode<T> node, T[] arraySaida, int index) {
      if (!node.isEmpty()) {
