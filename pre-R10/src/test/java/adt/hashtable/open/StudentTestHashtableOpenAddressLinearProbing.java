...
import main.java.adt.hashtable.open.HashtableOverflowException;
...
import main.java.adt.hashtable.open.HashtableOpenAddressLinearProbingImpl;
...
public class StudentTestHashtableOpenAddressLinearProbing {
	...
	public void testRemove() {
		...
		assertEquals(4, table1.getCOLLISIONS());
		table1.remove(new HashtableElement(12)); // Zerar colis�es
